...
@section('title')Creacion de Cursos | CodeTechEvolution @stop
...
<div class="card border-top-secondary border-top-3 mb-4">
  <div class="card-header d-flex align-items-center">
    ...
    <strong class="ms-2">Nuevo Curso</strong>
  </div>
  <div class="card-body">
    <div class="tab-content rounded-bottom">
      ...
      <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
        {{ html()->form('POST', '/admin/cursos/curso/')->attributes(['autocomplete'=>'off','files'=>'true','class'=>'row g-3'])->open() }}
          <div class="col-md-6">
            <label for="titulo" class="form-label">Titulo:</label>
            <input type="text" class="form-control" name="titulo" id="titulo" placeholder="Ingrese el título del curso">
          </div>
          <div class="col-md-6">
            <label for="slug" class="form-label">Slug:</label>
            <input type="text" class="form-control" name="slug" id="slug" placeholder="Ingrese el slug del curso">
          </div>
          <div class="col-md-6">
            <label for="precio" class="form-label">Precio:</label>
            <input type="number" class="form-control" name="precio" id="precio" min="0.00" step="0.01" placeholder="Ingrese el precio del curso">
          </div>
          <div class="col-md-6">
          ...
          <div class="col-12">
            ...
            <textarea class="form-control editorTiny" name="contenido" id="contenido" placeholder="Ingrese el contenido del curso"></textarea>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <div class="form-check form-switch form-switch-lg">
              <input class="form-check-input" type="checkbox" role="switch" name="certificado" id="certificado">
              <label class="form-check-label" for="certificado" id="lbl_cert">Certificado Inhabilitado</label>
            </div>
          </div>
          <div class="col-12">
