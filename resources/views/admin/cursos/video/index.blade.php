            ...
            <div class="col">
              <div class="card text-bg-dark">
                ...
                <div class="card-img-overlay">
                  <h5 class="card-title"><a href="/vv/c/{{ $vid->id }}" class="text-bg-dark popup-youtube" id="popup-1" style="--cui-bg-opacity:0;text-decoration:none;">{{ $vid->nombre }}</a></h5>
    ...
    $('.delete').click(function() {
      ...
      Swalmodal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $.ajax({
            type: 'DELETE',
            url: '/admin/cursos/video/' + registroId,
...
<script>
  ...
  $('.editarVid').click(function () {
    var registroId = $(this).data('id');
    $.ajax({
      url: '/admin/cursos/video/'+registroId+'/edit',
      method: 'GET',
      dataType: 'html',
      success: function (data) {
