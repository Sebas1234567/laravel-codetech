...
@section('title')Edición de Productos | CodeTechEvolution @stop
...
<div class="card border-top-secondary border-top-3 mb-4">
  <div class="card-header d-flex align-items-center">
    ...
    <strong class="ms-2">Editar Producto</strong>
  </div>
  <div class="card-body">
    <div class="tab-content rounded-bottom">
      ...
      <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
        {{ html()->modelForm($producto, 'PATCH')->route('admin.tienda.productos.update',$producto->id)->attributes(['autocomplete' => 'off','files'=>'true','class'=>'row g-3'])->open() }}
          <div class="col-md-6">
            <label for="titulo" class="form-label">Titulo:</label>
            <input type="text" class="form-control" name="titulo" id="titulo" placeholder="Ingrese el título del post" value="{{ $producto->titulo }}">
          </div>
          <div class="col-md-6">
            <label for="sku" class="form-label">Sku:</label>
            <input type="text" class="form-control" name="sku" id="sku" placeholder="Ingrese el sku del producto" value="{{ $producto->sku }}">
          </div>
          <div class="col-md-6">
            <label for="precio" class="form-label">Precio:</label>
            <input type="number" class="form-control" name="precio" id="precio" min="0.00" step="0.01" placeholder="Ingrese el precio del producto" value="{{ $producto->precio }}">
          </div>
          <div class="col-md-6">
            ...
            <select class="form-multi-select" name="categoria[]" id="categoria" multiple data-coreui-search="true" data-coreui-selection-type="tags">
              @php
                $categorias2 = explode(',', $producto->categorias);
              @endphp
          ...
          <div class="col-12">
            ...
            <textarea class="form-control editorTiny" name="descripcion" id="descripcion" placeholder="Ingrese la descripción del producto">{{ $producto->descripcion }}</textarea>
          </div>
          <div class="col-12">
            <label for="contenido" class="form-label">Contenido:</label>
            <textarea class="form-control editorTiny" name="contenido" id="contenido" placeholder="Ingrese el contenido del producto">{{ $producto->contenido }}</textarea>
          </div>
          <div class="col-12">
            <div class="mb-3">
          ...
          <div class="col-md-6">
            ...
            <div id="datePicker" data-coreui-footer="true" data-coreui-date="{{ \Carbon\Carbon::parse($producto->fecha_publicacion)->format('m/d/Y') }}"></div>
          </div>
          <div class="col-md-6">
            <label for="demo" class="form-label">Demo:</label>
            <input type="url" class="form-control" name="demo" id="demo" placeholder="Ingrese la url del demo del producto" value="{{ $producto->demo }}">
          </div>
          <div class="col-12">
