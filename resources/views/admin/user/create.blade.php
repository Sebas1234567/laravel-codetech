...
{{ html()->form('POST', '/admin/usuarios/')->attribute('autocomplete', 'off')->open() }}
<div class="modal-body">
  <div class="mb-3">
    <label class="form-label" for="nombre">Nombre:</label>
    <input class="form-control" name="nombre" id="nombre" type="text" placeholder="Ingrese el nombre completo del usuario">
  </div>
  <div class="mb-3">
    <label class="form-label" for="email">Email:</label>
    <input class="form-control" name="email" id="email" type="email" placeholder="Ingrese el email del usuario">
  </div>
  <label class="form-label" for="password">Contraseña:</label>
  <div class="input-group mb-3">
    <input class="form-control in-pass-s" name="password" id="password" type="password" placeholder="Ingrese la contraseña del usuario">
  ...
  <div class="input-group mb-3">
    <input class="form-control in-pass-s" name="password_confirmation" id="password-confirm" type="password" placeholder="Confirma la contraseña del usuario">
