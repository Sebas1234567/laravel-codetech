                ...
                <div class="card-body p-4">
                  ...
                  <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input class="form-control @error('email') is-invalid @enderror" type="email" placeholder="Email" name="email" id="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                      @error('email')
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input class="form-control" type="password" placeholder="Confirm Password" id="password-confirm" name="password_confirmation" required autocomplete="new-password">
                    </div>
                    <button class="btn btn-block btn-success" type="submit">Restablecer contraseña</button>
                  </form>
                </div>
              </div>
            </div>
